...
public class Ex5_3 {
	public static void main(String args[]) {
		...
		System.out.println("동일타입변수0=" + b10 + "," + b11 + "," + b12);
		int[][] b = new int[][] { { 8, 5, 2, 3, 6 }, { 5, 4, 1 } };
		System.out.println("동일타입배열0=" + b[0][0] + "," + b[0][1] + "," + b[0][2] + "," + b[0][3] + "," + b[0][4]);
		System.out.println("동일타입배열0=" + b[1][0] + "," + b[1][1] + "," + b[1][2]);
		System.out.println("동일타입배열0=");
		for (int i = 0; i < b[0].length; i++) {
			System.out.println(b[0][i] + "  ");
		}
		System.out.println("");
		System.out.println("동일타입배열1=");
		for (int i = 0; i < b[1].length; i++) {
			System.out.println(b[1][i] + "  ");
		}
		System.out.println("");
		// for(int i=0; i<b.length; i++){
		// for(int j=0; j<b[i].length; j++) System.out.println(b[i][j]+" ");
	}
